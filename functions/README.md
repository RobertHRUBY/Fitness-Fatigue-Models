...
| [inputData.csv](),    | An example mock dataset used across the various examples in [~/documentation](https://github.com/bsh2/Fitness-Fatigue-Models/tree/main/functions/documentation)                   |