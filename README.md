...
- Software
  - Illustrative: Contains procedural code tools for learning and apply advanced methods
    - Documentation
  - Utilities: Contains robust code tools for fitting and evaluating FFMs
    - Documentation
- Research : Contains 
- Experiments
  - Simulations
